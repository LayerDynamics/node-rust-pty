...
//     /// Test that `PtyOutputHandlerWrapper` correctly processes and renders PTY output.
//     #[test]
//     fn test_pty_output_handler_wrapper() {
//         // Initialize the renderer with a root node.
//         let renderer = Arc::new(Mutex::new(VirtualDomRenderer::new(VNode::element(
//             "root".to_string(),
//             HashMap::new(),
...
//         let mut pty_renderer = PtyOutputHandlerWrapper::new(renderer.clone());

//         // Simulate empty PTY output.
//         let empty_data = b"";
//         pty_renderer.handle_output(empty_data);
...
//         let data1 = b"Hello, ";
//         let data2 = b"World!";
//         pty_renderer.handle_output(data1);
//         pty_renderer.handle_output(data2);
