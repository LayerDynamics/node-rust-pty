...
mod platform {
    ...
    /// Represents an unsupported PTY process on other platforms
    #[derive(Debug)]
    pub struct PtyProcess;
...
/// Represents a handle to a PTY session
#[napi]
#[derive(Clone)]
...
/// Enum representing commands to be executed on the PTY
#[derive(Debug)]
enum PtyCommand {
    Write(Bytes),
    Resize(u16, u16),
...
/// Enum representing results of PTY operations
#[derive(Debug)]
enum PtyResult {
    Success(String),
    Failure(String),
...
impl PtyHandle {
    ...
    pub async fn new() -> Result<Self> {
        ...
        // Now pty_handle is of type PtyHandle
...
/// Test function to verify the creation, usage, and closure of PtyHandle
#[napi]
