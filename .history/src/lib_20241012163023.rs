...
impl PtyHandle {
    ...
    pub async fn new() -> Result<Self> {
        ...
        let handle = timeout(creation_timeout, task::spawn_blocking(|| {
    ...
    pub async fn read(&self) -> Result<String> {
        ...
        let result = match timeout(read_timeout, task::spawn_blocking(move || -> std::result::Result<String, napi::Error> {
        ...
        result // Now this is the extracted result value, no need to wrap it again
    }
