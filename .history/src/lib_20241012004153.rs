...
impl PtyHandle {
    ...
    pub async fn read(&self) -> Result<String> {
        ...
        let data = timeout(read_timeout, read_future)
            .await
            .map_err(|_| Error::new(
                Status::GenericFailure,
                "Read operation timed out.".to_string(),
            ))?
            .map_err(|e| e)?; // Propagate napi::Error
    ...
    pub async fn write(&self, data: String) -> Result<()> {
        ...
        timeout(write_timeout, write_future)
            .await
            .map_err(|_| Error::new(
                Status::GenericFailure,
    ...
    pub async fn resize(&self, cols: u16, rows: u16) -> Result<()> {
        ...
        timeout(resize_timeout, resize_future)
            .await
            .map_err(|_| Error::new(
                Status::GenericFailure,
    ...
    pub async fn close(&self) -> Result<()> {
        ...
        timeout(close_timeout, close_future)
            .await
            .map_err(|_| Error::new(
                Status::GenericFailure,
