        ...
        task::block_in_place(|| {
            ...
            if let Some(pty) = pty_option.take() {
                ...
                if unsafe { libc::close(pty.master_fd) } != 0 {
                    ...
                    info!("Dropping: Master_fd closed successfully.");  // Removed {} placeholder
                }
                ...
                if unsafe { libc::close(pty.slave_fd) } != 0 {
                    ...
                    info!("Dropping: Slave_fd closed successfully.");  // Removed {} placeholder
                }

                info!("Dropping: PTY session closed via Drop.");  // Removed {} placeholder
            } else {
