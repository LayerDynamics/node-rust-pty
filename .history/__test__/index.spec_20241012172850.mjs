...
import { PtyHandle } from "../darwin-x64/index.js"; // Ensure this path points to the correct built module
...
async function createPtyHandle(t) {
	try {
		...
		const ptyHandlePromise = PtyHandle.create(); // Use 'create' instead of 'new'
